...
$(document).ready(function(){
  ...
  // Color
  $("td").on('click','.editor__color', function(e) {
    // Paleta Colores
    // Mostrar / Ocultar
  ...
  $('#header-select').on('change',newsletter);
  ...
  function newsletter(){
    ...
    if (res) {
      //console.log('true')
      $('#view-content').attr('width','680');
      $('#emailing').attr('width','680');
    }else{
      $('#view-content').attr('width','610');
      $('#emailing').attr('width','100%');
    }
