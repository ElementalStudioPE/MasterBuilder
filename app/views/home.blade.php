...
<body>
  ...
  <input type="text" id="paletaBBVA" style="">
  ...
  <div class="container">
    ...
    <!-- ///////////////////////////////////////// -->
      ...
      <div class="construct__title">
        ...
        <a href="#" class="btn-generator-new noTab">Nuevo HTML</a>
        <a href="#" class="btn-generator-duplicate noTab">Nuevo HTML</a>
      ...
      <div class="scrollbar-outer blue">
        <div class="construct__panel ">
          ...
          <div class="panel">
            ...
            <select class="jsSelect panel__option" name="valores[]" id="" data-id='#cierre'>
              <option value="">...</option>
              <?php
                generaRutas("cierre");
              ?>
          ...
          <div class="panel">
            ...
            <select class="jsSelect panel__option" name="valores[]" id="" data-id='#disponible'>
              <option value="">...</option>
              <?php
                generaRutas("disponible");
              ?>
            </select>
          </div><!-- / .panel --> 
          ...
          <div class="panel">
            ...
            <select class="jsSelect panel__option" name="valores[]" id="" data-id='#claqueta'>
              <option value="">...</option>
              <?php
                generaRutas("claqueta");
              ?>
            </select>
          </div><!-- / .panel -->
          ...
          <div class="panel">
            ...
            <select class="jsSelect panel__option" name="valores[]" id="" data-id='#diclaimer'>
              <option value="">...</option>
              <?php
                generaRutas("disclaimer");
              ?>
            </select>
          </div><!-- / .panel -->
      ...
      <div class="copy">
        <img src="http://ess.pe/static/img/logo.png" alt="Elemental Studio" style="width: 84px;margin-top: 4px;">
      </div>
    </div><!-- / .construct -->
    ...
    <!-- VISUALIZADOR HTML                         -->
    <!-- ///////////////////////////////////////// -->
      <div class="scrollbar-outer gray" id="doc" contenteditable='true' data-replace="{{ URL::to('replace') }}" data-image="{{ URL::to('image') }}">
