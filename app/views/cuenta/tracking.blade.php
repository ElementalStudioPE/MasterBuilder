...
<div class="content">
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-md-12">
				<div class="card" style="box-shadow: inherit !important; background: inherit !important;">
					<div class="card-header" data-background-color="blue">
						...
						<p class="category" style="color: #fff;font-size: 15px;">Información del estado de los servicios</p>
					</div>
				...
				<!-- 	<div class="card-content table-responsive">
						<table class="table">
							...
							<tbody>
               @foreach( DB::table('vsalud_garantia')->where('usuario_codigo','=',Auth::user()->id)->whereNull('flg_pago')->get() as $vsalud_garantia )
               <tr>
                 <td>{{ $vsalud_garantia->c_documento }}</td>
                 <td>{{ $vsalud_garantia->clinica_nombre }}</td>
                 <td>{{ date('Y-m-d', strtotime( $vsalud_garantia->d_documento)) }}</td>
                 <td>{{ $vsalud_garantia->paciente }}</td>
                 <td>{{ $vsalud_garantia->servicio_nombre }}</td>
                 <td>{{ $vsalud_garantia->especialidad_nombre }}</td>
                 @if( $vsalud_garantia->flgestado == 'AUDITADO' )
                 Se muestra info
                 Se levanta pago
                 <td><span class="btn btn-default btn-xs">Pendiente Pagar</span></td>
                 <td class="td-actions text-right">
                  <button type="button" rel="tooltip" title="" class="btn btn-primary btn-simple btn-xs enableInfo" data-original-title="Visualizar registro" data-toggle="modal" data-target="#enableInfo" data-medico="{{$vsalud_garantia->c_medico_tratante}}" data-brindado="{{$vsalud_garantia->c_servicio_medico}}" data-carta="{{$vsalud_garantia->c_documento}}" data-clinica="{{$vsalud_garantia->clinica_nombre}}" data-fecha="{{ date('Y-m-d', strtotime($vsalud_garantia->d_documento)) }}" data-paciente="{{$vsalud_garantia->paciente}}" data-servicio="{{$vsalud_garantia->servicio_nombre}}" data-especialidad="{{$vsalud_garantia->especialidad_nombre}}" data-informe="{{$vsalud_garantia->c_informe_medico}}" data-precio="{{$vsalud_garantia->n_total}}" data-diagnostico="{{$vsalud_garantia->diagnostico_nombre}}">
                   <i class="material-icons">info</i>
                   <div class="ripple-container"></div>
                 </button>
                 <button type="button" rel="tooltip" title="" class="btn btn-success btn-simple btn-xs enablePagar" data-brindado="{{$vsalud_garantia->c_servicio_medico}}" data-carta="{{$vsalud_garantia->c_documento}}" data-clinica="{{$vsalud_garantia->clinica_nombre}}" data-fecha="{{ date('Y-m-d', strtotime($vsalud_garantia->d_documento)) }}" data-paciente="{{$vsalud_garantia->paciente}}" data-servicio="{{$vsalud_garantia->servicio_nombre}}" data-especialidad="{{$vsalud_garantia->especialidad_nombre}}" data-informe="{{$vsalud_garantia->c_informe_medico}}" data-precio="{{$vsalud_garantia->n_total}}" data-diagnostico="{{$vsalud_garantia->diagnostico_nombre}}">
               ...
               Se muestra info
               No se levanta pago
               <td><span class="btn btn-warning btn-xs">En Revisión</span></td>
               <td class="td-actions text-right">
                <button type="button" rel="tooltip" title="" class="btn btn-primary btn-simple btn-xs enableInfo" data-original-title="Visualizar registro" data-toggle="modal" data-target="#enableInfo" data-medico="{{$vsalud_garantia->c_medico_tratante}}" data-brindado="{{$vsalud_garantia->c_servicio_medico}}" data-carta="{{$vsalud_garantia->c_documento}}" data-clinica="{{$vsalud_garantia->clinica_nombre}}" data-fecha="{{ date('Y-m-d', strtotime($vsalud_garantia->d_documento)) }}" data-paciente="{{$vsalud_garantia->paciente}}" data-servicio="{{$vsalud_garantia->servicio_nombre}}" data-especialidad="{{$vsalud_garantia->especialidad_nombre}}" data-informe="{{$vsalud_garantia->c_informe_medico}}" data-precio="{{$vsalud_garantia->n_total}}" data-diagnostico="{{$vsalud_garantia->diagnostico_nombre}}">
                 <i class="material-icons">info</i>
                 <div class="ripple-container"></div>
               </button>
               <button type="button" rel="tooltip" title="" class="btn btn-success btn-simple btn-xs disabled" data-original-title="Pagar" data-toggle="modal" data-target="#disablePagar">
                 <i class="material-icons">monetization_on</i>
               </button>
             </td>
             ...
             Se muestra info
             No se levanta pago
             <td><span class="btn btn-danger btn-xs">En observación</span></td>
             <td class="td-actions text-right">
              <button type="button" rel="tooltip" title="" class="btn btn-primary btn-simple btn-xs enableInfo" data-original-title="Visualizar registro" data-toggle="modal" data-target="#enableInfo" data-medico="{{$vsalud_garantia->c_medico_tratante}}" data-brindado="{{$vsalud_garantia->c_servicio_medico}}" data-carta="{{$vsalud_garantia->c_documento}}" data-clinica="{{$vsalud_garantia->clinica_nombre}}" data-fecha="{{ date('Y-m-d', strtotime($vsalud_garantia->d_documento)) }}" data-paciente="{{$vsalud_garantia->paciente}}" data-servicio="{{$vsalud_garantia->servicio_nombre}}" data-especialidad="{{$vsalud_garantia->especialidad_nombre}}" data-informe="{{$vsalud_garantia->c_informe_medico}}" data-precio="{{$vsalud_garantia->n_total}}" data-diagnostico="{{$vsalud_garantia->diagnostico_nombre}}">
               <i class="material-icons">info</i>
               <div class="ripple-container"></div>
           ...
           Se muestra info
           No se levanta pago
           <td><span class="btn btn-success btn-xs">Pagado</span></td>
           <td class="td-actions text-right">
            <button type="button" rel="tooltip" title="" class="btn btn-primary btn-simple btn-xs enableInfo" data-original-title="Visualizar registro" data-toggle="modal" data-target="#enableInfo" data-medico="{{$vsalud_garantia->c_medico_tratante}}" data-brindado="{{$vsalud_garantia->c_servicio_medico}}" data-carta="{{$vsalud_garantia->c_documento}}" data-clinica="{{$vsalud_garantia->clinica_nombre}}" data-fecha="{{ date('Y-m-d', strtotime($vsalud_garantia->d_documento)) }}" data-paciente="{{$vsalud_garantia->paciente}}" data-servicio="{{$vsalud_garantia->servicio_nombre}}" data-especialidad="{{$vsalud_garantia->especialidad_nombre}}" data-informe="{{$vsalud_garantia->c_informe_medico}}" data-precio="{{$vsalud_garantia->n_total}}" data-diagnostico="{{$vsalud_garantia->diagnostico_nombre}}">
             <i class="material-icons">info</i>
             <div class="ripple-container"></div>
          ...
          <div class="row" style="margin: 5px 10px !important;">
           ...
           <!-- <button data-brindado="{{$vsalud_garantia->c_servicio_medico}}"> -->
            ...
            <div class="col-sm-6">
              ...
              <strong style="color: #3C4858 !important;font-weight: bold !important;font-size: 14px !important;">Estado</strong> <a href="#" data-toggle="modal" data-target="#disablePagar"><span class="btn {{$color_estado}} btn-xs">{{$estado}}</span></a>
              </h5>
            </div>
            <div class="col-sm-6">
              <h5 class="margin-bottom-0">
              @if( $estado == 'AUDITADO' )
              <button type="button" title="" class="btn btn-success btn-simple btn-xs pagarServicio" style="font-size: 14px;" data-brindado="{{$vsalud_garantia->c_servicio_medico}}" data-carta="{{$vsalud_garantia->c_documento}}" data-clinica="{{$vsalud_garantia->clinica_nombre}}" data-fecha="{{ date('Y-m-d', strtotime($vsalud_garantia->d_documento)) }}" data-paciente="{{$vsalud_garantia->paciente}}" data-servicio="{{$vsalud_garantia->servicio_nombre}}" data-especialidad="{{$vsalud_garantia->especialidad_nombre}}" data-informe="{{$vsalud_garantia->c_informe_medico}}" data-precio="{{$vsalud_garantia->n_total}}" data-diagnostico="{{$vsalud_garantia->diagnostico_nombre}}">
                 <i class="material-icons">monetization_on</i> Pagar
               </button>
               @else
               <button type="button" title="" class="btn btn-success btn-simple btn-xs disabled" data-toggle="modal" data-target="#disablePagar" style="font-size: 14px;">
                 <i class="material-icons">monetization_on</i> Pagar
               </button>
               @endif
              </h5>
      ...
      <div class="modal-body">
        <form class="form">
          ...
          <div class="footer text-center" style="padding: 0px 15px 10px 15px;position: relative;">
            <a href="{{route('cuenta.pagos')}}" class="btn btn-success btn-wd" style="width: 100%;">Ir al panel</a>
          </div>
        </form>
      </div>
    </div>
